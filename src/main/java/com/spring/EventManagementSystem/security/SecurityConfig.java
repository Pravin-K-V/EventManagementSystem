    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(req -> req
                        ...
                        .requestMatchers(new RegexRequestMatcher("^/users(/[^/]+)?$", "GET")).hasAuthority("admin")
                        .requestMatchers(new RegexRequestMatcher("^/getAllEnrolledUsers(/[^/]+)?$", "GET")).hasAuthority("organizer")
